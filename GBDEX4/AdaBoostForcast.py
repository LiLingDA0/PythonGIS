...
from sklearn.ensemble import AdaBoostClassifier  # 替换为AdaBoost
...
# 创建AdaBoost模型
adaboost_model = AdaBoostClassifier(n_estimators=50, random_state=42)  # 创建AdaBoost模型
...
with open(report_filename, 'w') as report_file:
    report_file.write("AdaBoost 模型评估结果:\n")
    report_file.write("\n")
