...
for gamma in gamma_values:
    ...
    # 创建SVM模型
    svm_model = SVC(kernel=KernelMethod, C=1.0, gamma=gamma, probability=True)
...
plt.subplot(2, 2, 3)
plt.plot(gamma_values, precisions, marker='o')
plt.xscale('log')
plt.xlabel('Gamma')
...
plt.subplot(2, 2, 4)
plt.plot(gamma_values, recalls, marker='o')
plt.xscale('log')
plt.xlabel('Gamma')
plt.ylabel('Recall (Macro)')
plt.title('Recall vs Gamma')
plt.grid(True)
plt.savefig('Results/SVM/'+KernelMethod+'_Gamma.png')
